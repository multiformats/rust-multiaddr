...
impl Arbitrary for Proto {
    fn arbitrary(g: &mut Gen) -> Self {
        ...
        match u8::arbitrary(g) % Proto::IMPL_VARIANT_COUNT {
            0 => Proto(Ip4(Ipv4Addr::arbitrary(g))),
            1 => Proto(Tcp(Arbitrary::arbitrary(g))),
            2 => Proto(Udp(Arbitrary::arbitrary(g))),
            3 => Proto(Dccp(Arbitrary::arbitrary(g))),
            4 => Proto(Ip6(Ipv6Addr::arbitrary(g))),
            5 => Proto(Ip6zone(Cow::Owned(SubString::arbitrary(g).0))),
            6 => Proto(Ipcidr(Arbitrary::arbitrary(g))),
            7 => Proto(Dns(Cow::Owned(SubString::arbitrary(g).0))),
            8 => Proto(Dns4(Cow::Owned(SubString::arbitrary(g).0))),
            9 => Proto(Dns6(Cow::Owned(SubString::arbitrary(g).0))),
            10 => Proto(Dnsaddr(Cow::Owned(SubString::arbitrary(g).0))),
            11 => Proto(Sctp(Arbitrary::arbitrary(g))),
            12 => Proto(Udt),
            13 => Proto(Utp),
            14 => Proto(Unix(Cow::Owned(SubString::arbitrary(g).0))),
            15 => Proto(P2p(PId::arbitrary(g).0)),
            16 => {
            ...
            20 => Proto(Tls),
            21 => Proto(Sni(Cow::Owned(SubString::arbitrary(g).0))),
            22 => Proto(Noise),
            23 => Proto(Quic),
            24 => Proto(QuicV1),
            25 => Proto(WebTransport),
            26 => Proto(Certhash(Mh::arbitrary(g).0)),
            27 => Proto(Http),
            28 => Proto(Https),
            29 => Proto(Ws("/".into())),
            30 => Proto(Wss("/".into())),
            31 => Proto(P2pWebSocketStar),
            32 => Proto(P2pStardust),
            33 => Proto(P2pWebRtcStar),
            34 => Proto(P2pWebRtcDirect),
            35 => Proto(WebRTCDirect),
            36 => Proto(WebRTC),
            37 => Proto(P2pCircuit),
            38 => Proto(Memory(Arbitrary::arbitrary(g))),
